...
\orcid{David A. Case}{}
\orcid{Julian C.-H. Chen}{}
\orcid{Lillian T. Chong}{}
\orcid{Daniel A. Keedy}{}
\orcid{Kresten Lindorff-Larsen}{}
\orcid{David L. Mobley}{}
\orcid{O.H. Samuli Ollila}{}
\orcid{Chris Oostenbrink}{}
\orcid{Paul Robustelli}{}
\orcid{Vincent A. Voelz}{}
\orcid{Michael E. Wall}{}
\orcid{David C. Wych}{}
\orcid{Michael K. Gilson}{}
...
{\bf The degeneracy between conformations and chemical shifts can often be resolved by analyzing the chemical shifts of multiple nuclei.}
...
Special attention, however, is needed to ensure correct mapping to the correct atoms in cases when stereospecific assignments are available.
...
%[Can we say something about experimental uncertainties for RDCs, as done for chemical shifts and scalar couplings?-- Mike]
...
%[Is there an accepted figure of merit for the agreement of computed PREs with experiment?-- Mike]
...
At cryogenic temperatures, there is little motion to simulate, and it is also not clear that the conformational variability observed at cryogenic temperatures corresponds to a well-defined thermodynamic ensemble at any particular temperature \cite{keedy_crystal_2014,cbradford_temperature_2021}.
...
As a consequence, neutron diffraction protein crystallography can provide experimental information on hydrogen atom positions and protonation states.
...
Ideally, one would choose the size of the supercell by running simulations of increasing size until the observables of interest stopped changing.
However, this is a computationally demanding exercise, and we are not aware of a study of this type.
As a consequence, the size of the supercell is typically chosen based on physical intuition regarding the range of motional correlations.
...
\begin{itemize}
    ...
    \item Section \ref{sub2:diffuse} on diffuse scattering by M.E.W. and D.C.W.
...
M.E.W. has an equity interest in and is a consultant for Eli Lilly and Company
